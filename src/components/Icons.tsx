    ...
    render: (spring: any, color: string, key: number) => {
      return (
        <animated.svg
          key={key}
          style={spring}
          className="flex-shrink-0 h-10 w-10 mr-5"
          role="img"
          fill={color}
          viewBox="0 0 24 24"
...
const Logos = ({
      ...
      to: [
        {
          ...
          width: tech?.includes(item.id) ? "2.5rem" : "0rem",
          config: { duration: 300, ...config.default },
        },
        {
          marginRight: tech?.includes(item.id) ? "1.25rem" : "0rem",
  ...
  return (
    <>
      <div className="flex flex-row items-center max-w-[50vw] overflow-y-hidden overflow-x-scroll">
